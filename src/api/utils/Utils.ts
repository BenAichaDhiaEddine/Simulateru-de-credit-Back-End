...
export function checkDuplicateField(error: any, field: string, errorMessage: string) {
...
// function to get only models with deleted = false
export const getActiveOnly = ({ query }: { query: any }) => {
